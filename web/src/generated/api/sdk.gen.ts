 ...
 */
export const ompUpdateEditCustomMirror = <ThrowOnError extends boolean = false>(options: Options<OmpUpdateEditCustomMirrorData, ThrowOnError>) => (options.client ?? client).patch<OmpUpdateEditCustomMirrorResponses, OmpUpdateEditCustomMirrorErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/omp/update/mirrors/custom/{id}',
    ...options,
    headers: {
