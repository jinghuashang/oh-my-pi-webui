...
export const projectsGetCloneProgressQueryKey = (options?: Options<ProjectsGetCloneProgressData>) => createQueryKey('projectsGetCloneProgress', options);

/**
 * Get real-time git clone progress percentage and stdout/stderr logs
 */
export const projectsGetCloneProgressOptions = (options?: Options<ProjectsGetCloneProgressData>) => queryOptions<ProjectsGetCloneProgressResponse, ProjectsGetCloneProgressError, ProjectsGetCloneProgressResponse, ReturnType<typeof projectsGetCloneProgressQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await projectsGetCloneProgress({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: projectsGetCloneProgressQueryKey(options)
});

/**
 * Cancel and abort an in-progress git clone task
 */
export const projectsCancelCloneMutation = (options?: Partial<Options<ProjectsCancelCloneData>>): UseMutationOptions<ProjectsCancelCloneResponse, ProjectsCancelCloneError, Options<ProjectsCancelCloneData>> => {
    const mutationOptions: UseMutationOptions<ProjectsCancelCloneResponse, ProjectsCancelCloneError, Options<ProjectsCancelCloneData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await projectsCancelClone({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Update an existing custom OMP update mirror
 */
export const ompUpdateEditCustomMirrorMutation = (options?: Partial<Options<OmpUpdateEditCustomMirrorData>>): UseMutationOptions<OmpUpdateEditCustomMirrorResponse, OmpUpdateEditCustomMirrorError, Options<OmpUpdateEditCustomMirrorData>> => {
    const mutationOptions: UseMutationOptions<OmpUpdateEditCustomMirrorResponse, OmpUpdateEditCustomMirrorError, Options<OmpUpdateEditCustomMirrorData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await ompUpdateEditCustomMirror({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const ompUpdateGetProgressQueryKey = (options?: Options<OmpUpdateGetProgressData>) => createQueryKey('ompUpdateGetProgress', options);

/**
 * Get real-time OMP update download progress and speed
 */
export const ompUpdateGetProgressOptions = (options?: Options<OmpUpdateGetProgressData>) => queryOptions<OmpUpdateGetProgressResponse, OmpUpdateGetProgressError, OmpUpdateGetProgressResponse, ReturnType<typeof ompUpdateGetProgressQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await ompUpdateGetProgress({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: ompUpdateGetProgressQueryKey(options)
});

/**
 * Cancel in-progress OMP update download or installation
 */
export const ompUpdateCancelUpgradeMutation = (options?: Partial<Options<OmpUpdateCancelUpgradeData>>): UseMutationOptions<OmpUpdateCancelUpgradeResponse, OmpUpdateCancelUpgradeError, Options<OmpUpdateCancelUpgradeData>> => {
    const mutationOptions: UseMutationOptions<OmpUpdateCancelUpgradeResponse, OmpUpdateCancelUpgradeError, Options<OmpUpdateCancelUpgradeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await ompUpdateCancelUpgrade({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const webuiUpdateCheckUpdateQueryKey = (options?: Options<WebuiUpdateCheckUpdateData>) => createQueryKey('webuiUpdateCheckUpdate', options);

/**
 * Check for WebUI git updates and remote commits
 */
export const webuiUpdateCheckUpdateOptions = (options?: Options<WebuiUpdateCheckUpdateData>) => queryOptions<WebuiUpdateCheckUpdateResponse, WebuiUpdateCheckUpdateError, WebuiUpdateCheckUpdateResponse, ReturnType<typeof webuiUpdateCheckUpdateQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await webuiUpdateCheckUpdate({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: webuiUpdateCheckUpdateQueryKey(options)
});

export const webuiUpdateGetMirrorsQueryKey = (options?: Options<WebuiUpdateGetMirrorsData>) => createQueryKey('webuiUpdateGetMirrors', options);

/**
 * Get list of mirrors with speed test results for WebUI updates
 */
export const webuiUpdateGetMirrorsOptions = (options?: Options<WebuiUpdateGetMirrorsData>) => queryOptions<WebuiUpdateGetMirrorsResponse, WebuiUpdateGetMirrorsError, WebuiUpdateGetMirrorsResponse, ReturnType<typeof webuiUpdateGetMirrorsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await webuiUpdateGetMirrors({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: webuiUpdateGetMirrorsQueryKey(options)
});

export const webuiUpdateGetProgressQueryKey = (options?: Options<WebuiUpdateGetProgressData>) => createQueryKey('webuiUpdateGetProgress', options);

/**
 * Get real-time WebUI update pull/build progress
 */
export const webuiUpdateGetProgressOptions = (options?: Options<WebuiUpdateGetProgressData>) => queryOptions<WebuiUpdateGetProgressResponse, WebuiUpdateGetProgressError, WebuiUpdateGetProgressResponse, ReturnType<typeof webuiUpdateGetProgressQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await webuiUpdateGetProgress({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: webuiUpdateGetProgressQueryKey(options)
});

/**
 * Cancel in-progress WebUI update pull or build
 */
export const webuiUpdateCancelUpgradeMutation = (options?: Partial<Options<WebuiUpdateCancelUpgradeData>>): UseMutationOptions<WebuiUpdateCancelUpgradeResponse, WebuiUpdateCancelUpgradeError, Options<WebuiUpdateCancelUpgradeData>> => {
    const mutationOptions: UseMutationOptions<WebuiUpdateCancelUpgradeResponse, WebuiUpdateCancelUpgradeError, Options<WebuiUpdateCancelUpgradeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await webuiUpdateCancelUpgrade({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const webuiUpdateUpgradeMutation = (options?: Partial<Options<WebuiUpdateUpgradeData>>): UseMutationOptions<WebuiUpdateUpgradeResponse, WebuiUpdateUpgradeError, Options<WebuiUpdateUpgradeData>> => {
    const mutationOptions: UseMutationOptions<WebuiUpdateUpgradeResponse, WebuiUpdateUpgradeError, Options<WebuiUpdateUpgradeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await webuiUpdateUpgrade({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
