...
import type { OmpService } from '../omp-engine.service';
import type { OmpStatusService } from '../omp-status.service';
import type { OmpProcessManager } from '../omp-process-manager.service';
...
describe('independent raw config repair', () => {
  ...
  beforeEach(() => {
    ...
    controller = new OmpEngineConfigController(
      { request } as unknown as OmpService,
      { invalidateCache: vi.fn() } as unknown as OmpStatusService,
      fixture.storage,
