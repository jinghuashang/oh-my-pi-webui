...
export const ErrorCode = {
  ...
  auth: {
    ...
    credentialsRequired: 'auth.credentials_required',
    alreadyInitialized: 'auth.already_initialized',
    usernameInvalid: 'auth.username_invalid',
    passwordWeak: 'auth.password_weak',
    rateLimited: 'auth.rate_limited',
  },

  // ── Git ────────────────────────────────────────────────────────────
  git: {
    commandFailed: 'git.command_failed',
    branchRequired: 'git.branch_required',
    messageRequired: 'git.message_required',
  },
